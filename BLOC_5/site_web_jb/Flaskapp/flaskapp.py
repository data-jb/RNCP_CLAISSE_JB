...
def get_random_anecdote(prediction):
    animal = prediction.replace("une ", "").replace("un ", "")  # delete from prediction
        ...
        if request.form["action"] == "Envoyer image":
            ...
            if not img:
                ...
                try:
                    ...
                    return render_template("predictions.html", prediction=m, confidence=confidence, a=a, color=color, affichage_niveau=affichage_niveau, width=width)
